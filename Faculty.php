        	...
        	<div class="panel panel-default">
        		<div class="panel-heading">
						...
						<div class col-md-offset-3" >
			    			<button type="button" class="btn btn-block btn-success outline">Remaining Balance : <?php echo $std->view_balance($conn,$user_login);?> </button>
						</br></br>
						...
						<a href="Cafe Order Online.html" class="btn btn-block btn-success gradient"><span class="glyphicon glyphicon-saved "></span> Cafe Order Online</a>
					<!--	</br></br>
						<a href="Tuckshop Order Online.html" class="btn btn-block btn-success gradient"><span class="glyphicon glyphicon-saved "></span> Tuckshop Order Online</a>
						-->
