        ...
        <span class="icon-bar"></span>
					...
					<div class="collapse navbar-collapse pull-right" id="main-menu">
                        <ul class="nav">
                            ...
                            <a href="shopkeeper_reset_password.php" class="btn btn-success btn-sm "><span class="glyphicon glyphicon-off"></span>Reset Password</a>
...
<div class="container">
		...
		<form action="Shopkeeper.php" method ="post" enctype="multipart/form-data">
						...
						<button href="" name="make_transaction" type="submit" class="btn btn-success gradient pull-right"><span class="glyphicon glyphicon-log-in"></span> Proceed</button>
			    		</form>
						</br></br>
						<div class="default">		
			    			<?php	
